...
broken line";
		...
		public void StringsCanBePaddedToTheLeft()
		{
			...
			Assert.Equal("  x", str); //why is this correct? it's only 2
		}
		...
		{
			var str = string.Format("{0:n}", 123456); // I can see answer bc of terminal, but I have no idea why it's the answer
		...
		public void CustomDateFormaters()
		{
			...
			Assert.Equal("P 35", str); //what the heck is this
		}
